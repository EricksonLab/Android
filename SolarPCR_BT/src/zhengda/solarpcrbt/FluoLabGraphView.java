	...
	*/	Log.d(Tag, "screen width =" + ValueSet.screenWidth + ",screen height=" + ValueSet.screenHeight);
    ...
    protected void onDraw(Canvas canvas) {  
        ...
        for (int i=2; i<ValueSet.screenWidth-3;i++){
        	canvas.drawLine(i,ValueSet.screenWidth-mDG.YAxisLocation[i],i+1,ValueSet.screenWidth-mDG.YAxisLocation[i+1],mPaint);
        }
        ...
        float step = (ValueSet.RightEdgeX-ValueSet.LeftEdgeX)/4;
        float Boundary[] = {(float)ValueSet.LeftEdgeX, (float)ValueSet.LeftEdgeX + step, (float)ValueSet.LeftEdgeX + step*2, (float)ValueSet.LeftEdgeX + step *3, (float)ValueSet.LeftEdgeX + step *4};
